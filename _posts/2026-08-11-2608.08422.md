...
score: 4.0
badge: medium
summary: The paper proposes a framework for generating realistic synthetic rankings
  from an observed population using a latent preference simplex embedding.
---
