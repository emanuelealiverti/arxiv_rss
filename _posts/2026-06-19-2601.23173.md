...
score: 6.5
badge: medium
summary: The paper introduces the Frankenfilter, a partially alive particle filter
  that targets a user-defined amount of success, improving the robustness and efficiency
  of pseudo-marginal Metropolis-Hastings for hidden Markov models.
---
