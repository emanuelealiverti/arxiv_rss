---
layout: post
title: Interpretable model-free inference of parametric variation across time-series
  data through large-scale feature extraction
date: '2026-06-11'
author: Ben D. Fulcher, Carl H. Lubba, Giorgio F. Gilestro, Simon R. Schultz, Nick
  S. Jones
author_display: Ben D. Fulcher, Carl H. Lubba, Giorgio F. Gilestro, Simon R. Schultz,
  Nick S. Jones
tags:
- stat.ME
arxiv_id: '2606.12836'
score: 4.0
badge: medium
summary: This paper proposes a data-driven approach to estimate parametric variation
  in time-series data without specifying a model, but its focus on interpretable model-free
  inference and large-scale feature extraction does not directly advance the researcher's
