...
author_display: Tian Zheng, Kai-Tai Hsu
tags:
- stat.AP
arxiv_id: '2606.24839'
score: 2.0
badge: low
summary: This paper evaluates the performance of automated graders on an agentic data
  analysis system, proposing a three-layer grading cascade and an iterative nudge
  mechanism to improve grading quality, but does not appear to be directly related
