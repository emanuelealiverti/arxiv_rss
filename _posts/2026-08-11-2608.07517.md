---
layout: post
title: 'The Judge Knows When It Knows: Calibrated Abstention for LLM-Based A/B-Test
  Prediction'
date: '2026-08-11'
author: Tyler Dooskin, Squoosh Technical Staff
author_display: Tyler Dooskin, Squoosh Technical Staff
tags:
- stat.AP
arxiv_id: '2608.07517'
score: 2.0
badge: low
summary: The paper presents experiments on using a multimodal LLM to predict A/B test
  outcomes from screenshots.
---
