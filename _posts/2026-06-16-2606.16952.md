...
score: 2.0
badge: low
summary: This paper presents a framework for auditing synthetic data to detect and
  explain potential privacy disclosures, but it does not directly advance the researcher's
