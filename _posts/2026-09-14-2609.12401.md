---
layout: post
title: Optimization of ReaxFF parameters for the $\mathrm{Mo-S}$ system using random
  optimization and coordinate search
date: '2026-09-14'
author: Arun Ravichandran, Michael Stein, Mert Sengul, Ying Hung, Tirthankar Dasgupta
author_display: Arun Ravichandran, Michael Stein, Mert Sengul, Ying Hung, Tirthankar
  Dasgupta
tags:
- stat.AP
arxiv_id: '2609.12401'
score: 2.0
badge: low
summary: Optimized ReaxFF parameters for the Mo-S system using random optimization
  and coordinate search.
---
