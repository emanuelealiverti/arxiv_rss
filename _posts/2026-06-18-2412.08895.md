...
score: 7.5
badge: high
summary: This paper proposes a computationally tractable Bayesian method for wideband
  signal detection using reversible-jump Markov chain Monte Carlo (RJMCMC) and stripe
  matrix decomposition, advancing the field of Bayesian signal processing.
---
