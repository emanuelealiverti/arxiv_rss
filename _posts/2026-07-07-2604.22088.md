...
score: 6.5
badge: medium
summary: This paper proposes a probabilistic model for zero-inflated count tensors
  with structured latent representations, developing a zero-inflated Poisson tensor
  model and a likelihood-based estimation procedure for distinguishing structural
  zeros from technical zeros.
---
