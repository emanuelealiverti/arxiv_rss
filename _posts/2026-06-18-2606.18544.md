...
score: 2.0
badge: low
summary: This paper presents a novel approach to detecting cheating in chess using
  the signature transform of rough-path theory, but it does not appear to be directly
