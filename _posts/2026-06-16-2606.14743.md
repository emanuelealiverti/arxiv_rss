---
layout: post
title: Delayed acceptance sampling with Hamiltonian proposal subchains for random
  field materials inference
date: '2026-06-16'
author: Simona Bérešová, Michal Béreš, Tomáš Luber, Stanislav Sysala
author_display: Simona Bérešová, Michal Béreš, Tomáš Luber, Stanislav Sysala
tags:
- stat.CO
arxiv_id: '2606.14743'
score: 7.0
badge: high
summary: This paper presents a method for accelerating Markov chain Monte Carlo sampling
  in Bayesian inverse problems using delayed acceptance and Hamiltonian proposal subchains,
  with a focus on geotechnical inverse problems.
---
