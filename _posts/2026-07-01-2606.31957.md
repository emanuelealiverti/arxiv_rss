---
layout: post
title: 'Locally stationary Argo ocean heat content estimates: Modeling, validation
  and uncertainty quantification'
date: '2026-07-01'
author: Thea Sukianto, Mikael Kuusela, Donata Giglio, Anirban Mondal, Pulong Ma, Douglas
  W. Nychka
author_display: Thea Sukianto, Mikael Kuusela, Donata Giglio, Anirban Mondal, …, Douglas
  W. Nychka
tags:
- stat.AP
- stat.ME
...
score: 2.0
badge: low
summary: This paper presents a framework for estimating ocean heat content using Argo
  profiling floats, but it does not appear to advance the researcher's core topics
