...
score: 7.0
badge: high
summary: The paper presents a unified framework for inferring habitat selection and
  utilization distributions from irregular and error-prone animal tracking data, addressing
  challenges of measurement error and temporal irregularity in habitat selection inference.
---
