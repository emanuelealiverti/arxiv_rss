---
layout: post
title: Rigorous uncertainty quantification of probabilistic AI weather forecasts with
  conformal prediction
date: '2026-06-19'
author: Anna Asch, Raphael Rossellini, Pedram Hassanzadeh, Rebecca Willett
author_display: Anna Asch, Raphael Rossellini, Pedram Hassanzadeh, Rebecca Willett
tags:
- stat.AP
- stat.ML
arxiv_id: '2606.19642'
score: 4.0
badge: medium
summary: This paper applies conformal prediction to improve the uncertainty quantification
  of AI weather forecasts, but its focus on weather forecasting and lack of direct
  connection to the researcher's core topics in Bayesian methodology and computation
  for complex data limits its relevance.
---
