...
author_display: Sagnik Nandy, Samriddha Lahiry, Pragya Sur, Subhabrata Sen
tags:
- stat.ME
- stat.ML
- stat.TH
...
score: 4.5
badge: medium
summary: DAIF is a data-adaptive intermediate fusion framework for multimodal supervised
  learning via approximate message passing.
---
