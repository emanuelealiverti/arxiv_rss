...
score: 8.0
badge: high
summary: The authors propose a novel method for approximating posterior distributions
  on statistical manifolds, bypassing the need for costly geometric computations and
  achieving faster computation while retaining accuracy.
---
