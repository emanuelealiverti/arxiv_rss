---
layout: post
title: Unsupervised Consensus-Based Anomaly Detection for Spatiotemporal Malaria Incidence
  in Ghana
date: '2026-07-24'
author: T. Ansah-Narh, Y. Asare Afrane
author_display: T. Ansah-Narh, Y. Asare Afrane
tags:
- stat.AP
- stat.ML
arxiv_id: '2607.21559'
score: 2.0
badge: low
summary: A consensus anomaly detection framework was applied to malaria surveillance
  data in Ghana to identify atypical transmission patterns.
---
