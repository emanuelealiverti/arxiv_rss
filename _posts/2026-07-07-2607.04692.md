...
score: 4.5
badge: medium
summary: This paper proposes a consistent estimator for conditional mean independence
  using nearest neighbor graphs, which can be used for model evaluation and feature
  screening.
---
