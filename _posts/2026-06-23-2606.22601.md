---
layout: post
title: Scalable Bayesian Additive Models for Stellar Flare Detection via Amortized
  Gaussian Process Inference and Hidden Markov Models
date: '2026-06-23'
author: Rodrigo Herrera, Vianey Leos-Barajas, Gwendolyn Eadie, Elizaveta Semenova,
  James Davenport
author_display: Rodrigo Herrera, Vianey Leos-Barajas, Gwendolyn Eadie, Elizaveta Semenova,
  James Davenport
tags:
- stat.ML
- stat.AP
...
score: 8.5
badge: high
summary: This paper introduces a generative surrogate framework using Variational
  Autoencoders to approximate Gaussian Process inference, enabling scalable Bayesian
  additive models for time-series analysis in astronomy.
---
