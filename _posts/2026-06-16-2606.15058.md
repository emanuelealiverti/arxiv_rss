...
date: '2026-06-16'
author: Louis Agyekum, Edmund Fosu Agyemang, Obu-Amoah Ampomah, Kofi Acheampong, Emmanuel
  Boadi, Priscilla Yaa Amakye, Fafa Shalom Tchorly, Enock Adu Bonsu, Eric Nyarko
author_display: Louis Agyekum, Edmund Fosu Agyemang, Obu-Amoah Ampomah, Kofi Acheampong,
  …, Eric Nyarko
tags:
- stat.AP
arxiv_id: '2606.15058'
score: 2.0
badge: low
summary: This paper compares the performance of machine learning models to a naive
  random walk benchmark in forecasting the CAD/USD exchange rate, but does not contribute
  to the researcher's core topics of Bayesian methodology and computation.
---
